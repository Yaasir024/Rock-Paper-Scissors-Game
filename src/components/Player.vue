...
const emits = defineEmits(['registerChoice', 'resetGame'])
</script>
...
<div class="player">
      <div class="icons-container">
        <div class="top">
          <button class="icon rock" @click="$emit('registerChoice', 'rock')">
            <svg
          ...
          <button class="icon scissors" @click="$emit('registerChoice', 'scissors')">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              width="50"
        ...
        <div class="bottom">
          <button class="icon paper" @click="$emit('registerChoice', 'paper')">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              width="50"
      ...
      <button class="try-again-btn restart-btn" @click="$emit('resetGame')">Restart</button>
    </div>
</template>
