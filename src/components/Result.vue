<template>
  <div class="result">
    <div class="winner-banner">
      <h1 v-if="winner == 'player'">YOU WIN</h1>
      <h1 v-if="winner == 'computer'">COMPUTER WINS</h1>
      <h1 v-if="winner == 'draw'">DRAW</h1>
    </div>
    <div class="choice">
      <div class="player-choice">
        <button class="icon rock" v-if="playerChoice == 'rock'">
          <svg
        ...
        <button class="icon paper" v-if="playerChoice == 'paper'">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            width="50"
        ...
        <button class="icon scissors" v-if="playerChoice == 'scissors'">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            width="50"
      ...
      <div class="computer-choice">
        <button class="icon rock" v-if="computerChoice == 'rock'">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            width="50"
        ...
        <button class="icon paper" v-if="computerChoice == 'paper'">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            width="50"
        ...
        <button class="icon scissors" v-if="computerChoice == 'scissors'">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            width="50"
...
<script setup>
const props = defineProps(["playerChoice", "computerChoice", "winner"]);
</script>
